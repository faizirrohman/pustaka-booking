...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <a href="<?= base_url('laporan/export_excel_pinjam'); ?>"class="btn btn-success mb-3"><i class="far fa-file-excel"></i> Export Excel</a>
            <table class="table table-bordered table-striped">
                <thead>
                    <tr>
                        ...
                        <th scope="col">Tanggal Dikembalikan</th> <th scope="col">Total Denda</th>
